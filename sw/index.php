...
<html lang="ar">
  ...
  <div id="main">
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="index.php">simple<span class="logo_colour">style_3</span></a></h1>
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li dir="rtl" class="selected"><a href="index.php">Home</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>Welcome to the simplestyle_3 template</h1>
